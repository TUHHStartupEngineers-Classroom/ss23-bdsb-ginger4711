...
bike_orderlines_wrangled_tbl %>%
  write_xlsx("src/ds_data/01_bike_sales/02_wrangled_data/bike_orderlines.xlsx")

# 7.2 CSV ----
bike_orderlines_wrangled_tbl %>% 
  write_csv("src/ds_data/01_bike_sales/02_wrangled_data/bike_orderlines.csv")

# 7.3 RDS ----
bike_orderlines_wrangled_tbl %>% 
  write_rds("src/ds_data/01_bike_sales/02_wrangled_data/bike_orderlines.rds")
